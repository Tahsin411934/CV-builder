...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2025 at 11:47 PM
...
(26, '/storage/images/UN8p6HbR4Z0fQKCoccJz0J9bVPpceFNmdEiI3fd0.jpg', 'jgdshdfh', 'hdfghdfhdh');
...
INSERT INTO `instructions` (`id`, `instruction`, `user_email`, `pdf_file`) VALUES
(2, 'Please follow the steps carefully to complete the setup.', 'testudser@example.com', NULL),
(3, 'ssssPlease follow thedsfafc dddsteps carefully to complete thsadffffffffffffffffffe setup.', 'testudsedr@example.com', NULL),
(4, 'gfdsgsdfgdfasfadfghdhgddfafdaf', 'cusu@mailinator.com', 0x696e737472756374696f6e732f5877664f73395064626d32343635357561776547437271454e6c35474d3576356f36536747544e752e706466),
(5, 'gsdfgsdfgsd', 'temyxic@mailinator.com', 0x696e737472756374696f6e732f5a79794751375042794b37485341784b584170495a723577355a4454316350357a5048336a6e494a2e706466);
...
(7, 'hdghdfgh', 'temyxic@mailinator.com');
...
CREATE TABLE `payments` (
  ...
  `updated_cv` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `payments` (`id`, `user_email`, `method`, `transaction_number`, `upload_ss`, `created_at`, `updated_at`, `verify`, `updated_cv`) VALUES
(34, 'temyxic@mailinator.com', 'Bkash', 'dfafads', 'uploads/bxkcYPGCds6Jz5uIGVtuaVw6mubNvOVjBObMy3Xl.jpg', '2025-03-15 10:13:07', '2025-03-15 14:45:49', 'delivered', 'uploads/1742071490_Hajj Kafela.pdf'),
(35, 'temyxic@mailinator.com', 'Nagad', 'fdsafsf', 'uploads/8Ydv4FFEGpx1N24Id7iRGsTxBoHjGOIbI4FQskFz.jpg', '2025-03-15 10:50:08', '2025-03-15 14:26:08', 'delivered', 'uploads/1742070368_Piper Stout - Irure amet dolore e.pdf'),
(37, 'temyxic@mailinator.com', 'Nagad', 'rewtrwt', 'uploads/L23AXKKkjbmTgjCGWeNGw59sBJZqHI0ScdOFBCoF.jpg', '2025-03-15 10:52:21', '2025-03-15 14:45:46', 'delivered', 'uploads/1742071502_Hajj Kafela.pdf'),
(39, 'temyxic@mailinator.com', 'Bkash', 'jhgdjfhgds', 'uploads/8uEb811Ptz0arockiq3wG4oRcRQlLAZTY5r8XXG8.jpg', '2025-03-15 14:52:06', '2025-03-15 14:52:06', 'no', NULL),
(42, 'cusu@mailinator.com', 'Nagad', 'fdafda', 'uploads/3SisIcNkZZ8ApVLwIwpI7nwWIlAuNOgXtcjRLLc0.jpg', '2025-03-15 15:54:10', '2025-03-15 16:27:10', 'delivered', 'uploads/1742077627_Hajj Kafela.pdf');
...
(137, 'App\\Models\\User', 23, 'auth_token', '313223d7f01da74fef26e0aa1f67fc6303c931e0ae63fe243252b575b8ee5097', '[\"*\"]', NULL, NULL, '2025-03-15 15:16:49', '2025-03-15 15:16:49');
...
--
-- Table structure for table `selectedtamplate`
--

CREATE TABLE `selectedtamplate` (
  `id` int(11) NOT NULL,
  `tamplate_id` varchar(255) DEFAULT NULL,
  `user_email` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `selectedtamplate`
--

INSERT INTO `selectedtamplate` (`id`, `tamplate_id`, `user_email`) VALUES
(1, '18', 'temyxic@mailinator.com'),
(2, '3', 'fgdsastestudsnnnnnedr@example.com'),
(3, '3', 'ew3fgdsastestudsnnnnnedr@example.com'),
(4, '22', 'cusu@mailinator.com');
...
(29, 'Josephine Farley', 'temyxic@mailinator.com', '2025-03-15 11:35:58', '2025-03-15 11:35:58', 'Eos nisi dolore qui', 'Ut aspernatur illo i', 'Tempor et dignissimo', 'Sed excepturi qui co', '+1 (567) 252-7314', NULL);
...
(25, 'Nissim Rowland', 'temyxic@mailinator.com', NULL, '$2y$12$uD3QFi6A.JPBExzxr3wha.WfTLIatwxHEo2HmX7CzB0IfRKJq5ZlK', NULL, '2025-03-15 05:08:05', '2025-03-15 05:08:05');
...
--
-- Indexes for table `selectedtamplate`
--
ALTER TABLE `selectedtamplate`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `selectedtamplate`
--
ALTER TABLE `selectedtamplate`
